export const FACTION_DEFINITIONS = Object.freeze([
  Object.freeze({
    id:'newAntioch', index:0, name:'New Antioch', short:'ANTIOCH', color:'#9ebdca', gameplayRole:'DEFENDER', deploymentZone:Object.freeze({minX:1,maxX:65}),
    ink:Object.freeze([.46,.59,.62]), accent:Object.freeze([.64,.22,.12]), base:Object.freeze([25,123]), resource:'İkmal',
    visualProfile:Object.freeze({strategy:'newAntioch', organic:false, smokeTint:'soot'}),
    allowedUnits:Object.freeze(['infantry','heavy','engineer']), allowedBuildings:Object.freeze(['hq','barracks','workshop','supply','materialDepot','hospital','observation','trench','sandbag','barbedWire','defense']),
  ...
  Object.freeze({
    id:'blackGrail', index:1, name:'Black Grail', short:'GRAIL', color:'#a4b56c', gameplayRole:'ATTACKER', deploymentZone:Object.freeze({minX:103,maxX:167}),
    ink:Object.freeze([.35,.42,.22]), accent:Object.freeze([.5,.22,.23]), base:Object.freeze([143,45]), resource:'Öz',
